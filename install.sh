...
echo ""
echo "============================================"
echo "  Installed 15 design skills"
echo "============================================"
echo ""
...
echo ""
echo "  PLAN & REVIEW"
echo "    /ui-ux-pro-max       — 50+ styles, 161 palettes, 57 font combos"
...
echo ""
echo "  REFERENCE"
echo "    design-systems/        — 69 real DESIGN.md files (Apple, Stripe,"
echo "                             Linear, Spotify, etc.) — drop one in your"
echo "                             project and say 'build a page like this'"
echo ""
echo "============================================"
echo ""
echo "NEXT STEP: Create your personal design style."
echo ""
echo "Create a file at ~/.claude/memory/design-style.md"
echo "with your preferred colors, fonts, and aesthetic rules."
echo "Claude reads it every session and follows your taste."
echo ""
echo "A template was included — see design-style-template.md"
echo "in this folder for a starting point."
echo ""
echo "============================================"
echo "  Ready to design. Open Claude Code and go."
echo "============================================"
echo ""
